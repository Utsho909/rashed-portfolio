...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-6 left-0 w-full z-50 pointer-events-none px-4">
      <nav
        className={`pointer-events-auto mx-auto max-w-4xl transition-all duration-500 rounded-full ${scrolled ? 'bg-white/70 backdrop-blur-xl shadow-lg border border-white/20 px-8 py-3' : 'bg-black/20 backdrop-blur-md px-8 py-4 border border-white/10'
          }`}
      >
